<?php
	...
	echo "<form><h2>Input numbers</h2><input type='text' name='input' placeholder='numbers separated by dash, ex. 10-20-40' style='width:500px' autofocus></form>";
    ...
    for($i=0,$n=count($arr_input);$i<$n;$i++) {
        $tree->create($arr_input[$i]);
    }
